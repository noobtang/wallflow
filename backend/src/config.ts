...
const envSchema = z.object({
  ...
  // 自有服务器存储(2026-08-15 首选,优先级高于 COS): 图片落盘目录 + 公网访问域名
  SELF_HOST_STORAGE_DIR: z.string().default(''),
  SELF_HOST_BASE_URL: z.string().default(''),
  ...
  // 公开写接口限流(2026-08-15 E 运维小项): 滑动窗口(窗口毫秒 / 窗口内最大请求数)
