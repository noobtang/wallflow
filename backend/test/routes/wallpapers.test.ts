...
describe('GET /wallpapers/search(#6 路由)', () => {
  ...
  beforeAll(async () => {
    ...
    await repo.upsert({
      ...
      sourceId: 'route-1',
      title: '银河星空',
      url: 'https://cos-mock.local/route-1.jpg',
      thumbUrl: 'https://cos-mock.local/route-1_thumb.jpg',
      license: 'CC0',
    ...
    await repo.upsert({
      ...
      sourceId: 'route-2',
      title: '山间湖泊',
      url: 'https://cos-mock.local/route-2.jpg',
      thumbUrl: 'https://cos-mock.local/route-2_thumb.jpg',
      license: 'CC0',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      creator: 'T',
      creatorUrl: 'https://example.com',
  ...
  it('HTTP 层翻页: nextCursor 往返,分页无重复', async () => {
    ...
    for (let i = 0; i < 3; i++) {
      await repo.upsert({
        ...
        title: `城市夜景${i}`,
        url: `https://cos-mock.local/route-city-${i}.jpg`,
        thumbUrl: `https://cos-mock.local/route-city-${i}_thumb.jpg`,
        license: 'CC0',
        licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
        creator: 'T',
        creatorUrl: 'https://example.com',
